...
# 입력창
t = st.sidebar.text_input('가장 좋아하는 과목은 무엇이고, 그 과목의 어떤 점이 제일 재밌어?', key='title')
...
q1 = st.text_area("", key='question1_answer')
q2 = st.text_area("", key='question2_answer')
...
if st.button("직업 추천받기"):
    if not st.session_state.memos:
        ...
        with st.spinner("직업을 분석하고 추천 중입니다..."):
            ...
            추가 답변:
            - 해결하고 싶은 문제: {st.session_state.question1_answer}
            - 배우고 싶은 기술/분야: {st.session_state.question2_answer}
